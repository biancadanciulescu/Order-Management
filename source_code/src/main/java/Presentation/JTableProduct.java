...
/**
 * Clasa JTableProduct reprezintă o fereastră pentru afișarea tabelară a produselor.
 */

public class JTableProduct extends JFrame {
...
//        f.setVisible(true);
        ...
        JTable table = productDAO.createTable(productDAO.findAll());
